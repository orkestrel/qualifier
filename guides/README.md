...
| --------- | ------------------------------ | ------------------------- | ------------------------------------- |
| Qualifier | [`qualifier.md`](qualifier.md) | [`src/core`](../src/core) | [`tests/src/core`](../tests/src/core) |

## By directory

| Directory  | Guide                          |
| ---------- | ------------------------------ |
| `src/core` | [`qualifier.md`](qualifier.md) |
...
- [`AGENTS.md`](../AGENTS.md) — the documentation contract these guides are held to.
